...
from futureframe.features import TrainDataset, preprocess
...
class CM2InputEncoder(nn.Module):
    ...
    def load(self, ckpt_dir):
        ...
        # model_name = os.path.join(ckpt_dir, INPUT_ENCODER_NAME)
...
def main(cpt, task_data, device="cpu"):
    # TODO: just make this look nice to show to Jeremy in an example script.
    skf = StratifiedKFold(n_splits=5, random_state=42, shuffle=True)
    all_res = {}

    task_dataset = task_data.split(",")
    ...
    for table_file_path in task_dataset:
        ...
        X, y, cat_cols, num_cols, bin_cols = preprocess(df)
        ...
        for trn_idx, val_idx in skf.split(X, y):
            ...
            ans = evaluate(ypred, y_test, metric="auc", num_class=num_class)
    ...
    res_path = str(exp_log_dir) + os.sep + "res.csv"
